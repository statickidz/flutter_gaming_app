              ...
              child: Container(
                child: SizedBox(
                    ...
                    child: CircleAvatar(
                      ...
                      child: ClipOval(
                        child: Image.network(
                          'https://randomuser.me/api/portraits/men/$totalUsers.jpg',
                        ),
                      ),
                    )),
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      child: Container(
        ...
        child: Column(
          children: [
            _buildRow('Nightingale'),
            _buildRow('Headshooter1980'),
            _buildRow('Nightingale 3'),
            _buildRow('Nightingale 5'),
            _buildRow('Nightingale 6'),
            _buildRow('Nightingale 8'),
            _buildRow('Nightingale 5')
          ],
        ),
      ),
